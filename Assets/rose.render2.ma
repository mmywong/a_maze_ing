...
//Name: rose.render[2].ma
//Last modified: Fri, Mar 24, 2017 03:41:09 AM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 68.97685732658411 46.208236764192449 -41.759290475764409 ;
	setAttr ".r" -type "double3" -26.138352741280887 5524.9999999994552 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "2D8B72A7-684C-BB9C-9209-AF88169B5B82";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 86.257357590119724;
