...
//Name: diamond.card.ma
//Last modified: Fri, Mar 24, 2017 04:54:06 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.830285541657283 35.5089505816429 14.557009956790214 ;
	setAttr ".r" -type "double3" -52.538352730009123 1131.8000000001359 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "60A881B7-8D4B-23C4-472A-0BBCD0DC9E13";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 27.609505067640658;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.3687566264092901 19.222103927400017 100.1 ;
...
createNode transform -n "pCube2";
	rename -uid "3AD627D0-194F-3E77-5BC2-07B3CEA23B63";
	setAttr ".t" -type "double3" -0.72275471172661776 17.464018974480716 -1.1737738419433104 ;
	setAttr ".r" -type "double3" 92.017653148430455 -2.0980941390747918 46.101451204108379 ;
	setAttr ".s" -type "double3" 1.1896974924404125 0.97903009975149624 1.0454011586690206 ;
createNode mesh -n "pCubeShape2" -p "pCube2";
	rename -uid "551BF1C3-1F48-4E40-DDC8-38A676A8F109";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 5 ".pt";
	setAttr ".pt[0]" -type "float3" -0.97650027 0.083673753 1.067981 ;
	setAttr ".pt[2]" -type "float3" -0.97650027 0.083673753 1.067981 ;
	setAttr ".pt[5]" -type "float3" 0.79682428 -0.068277806 -0.87147266 ;
	setAttr ".pt[7]" -type "float3" 0.79682428 -0.068277806 -0.87147266 ;
...
createNode transform -n "pasted__pCube2" -p "group1";
	rename -uid "41FCE1CE-6B46-38E3-8CEA-CB91F9AFDD88";
	setAttr ".t" -type "double3" -0.72275471172661776 17.464018974480716 -1.1737738419433104 ;
	setAttr ".r" -type "double3" 92.945322256601827 -2.4525978627929015 46.083199555559069 ;
	setAttr ".s" -type "double3" 1.1896974924404125 0.97903009975149624 1.0454011586690206 ;
createNode mesh -n "pasted__pCubeShape2" -p "|group1|pasted__pCube2";
	rename -uid "63A8C212-4540-36EC-D865-3295E14E92B8";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.625 0.25 ;
...
createNode transform -n "pasted__pasted__pCube2" -p "pasted__group1";
	rename -uid "ED48893F-DF4A-8A3A-7FB1-7AB6093788B4";
	setAttr ".t" -type "double3" -0.72275471172661776 17.464018974480716 -1.1737738419433104 ;
	setAttr ".r" -type "double3" 92.945322256601827 -2.4525978627929015 46.083199555559069 ;
	setAttr ".s" -type "double3" 1.1896974924404125 0.97903009975149624 1.0454011586690206 ;
createNode mesh -n "pasted__pasted__pCubeShape2" -p "pasted__pasted__pCube2";
	rename -uid "574B1B1B-1A42-91F7-9418-AD87A77F9386";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.625 0.25 ;
...
createNode transform -n "pasted__pasted__pasted__pCube2" -p "|group4|pasted__group2|pasted__pasted__group1";
	rename -uid "5B44AD87-C24D-5DA3-114E-DD8C63ACE946";
	setAttr ".t" -type "double3" -47.125553480082836 -18.248916356295521 -5.13715518340278 ;
	setAttr ".r" -type "double3" 92.945322256601827 -2.4525978627929015 46.083199555559069 ;
	setAttr ".s" -type "double3" 1.1896974924404125 0.97903009975149624 1.0454011586690206 ;
createNode mesh -n "pasted__pasted__pasted__pCubeShape2" -p "pasted__pasted__pasted__pCube2";
	rename -uid "2F0601D9-D04C-809D-A054-36AAB2359E01";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.625 0.25 ;
...
createNode transform -n "pasted__pCube2" -p "group5";
	rename -uid "AEA168FC-FB44-6655-7DB9-318D9066E1A8";
	setAttr ".t" -type "double3" -0.052757289437723731 14.383222622950655 -0.63125344212586865 ;
	setAttr ".r" -type "double3" 91.884785764300489 -1.9243491657128611 49.973181243840514 ;
	setAttr ".s" -type "double3" 1.1896974924404125 0.97903009975149624 1.0454011586690206 ;
createNode mesh -n "pasted__pCubeShape2" -p "|group5|pasted__pCube2";
	rename -uid "94106EEC-7542-704B-1538-E484FE929079";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.625 0.25 ;
...
createNode transform -n "pasted__pCube2" -p "group6";
	rename -uid "052FE276-C443-7272-36B4-43B9D0731338";
	setAttr ".t" -type "double3" -12.266717724526604 17.178195228373923 -2.328851403969292 ;
	setAttr ".r" -type "double3" 92.017653148430455 -2.0980941390747918 46.101451204108386 ;
	setAttr ".s" -type "double3" 0.18025135328482914 -0.10280875143034722 0.15838898104179816 ;
createNode mesh -n "pasted__pCubeShape2" -p "|group6|pasted__pCube2";
	rename -uid "7493C779-984F-5B3E-CB7E-E199AB240429";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pPrism1";
	rename -uid "F50CD76D-C143-010D-F622-779DF7133B33";
	setAttr ".t" -type "double3" -0.87968235076774715 18.832503190783136 -0.98269098120214826 ;
	setAttr ".r" -type "double3" 92.841786042164401 1.2703539776129569 -29.899818664192832 ;
	setAttr ".s" -type "double3" 0.77676491723571495 0.77676491723571495 0.77676491723571495 ;
createNode mesh -n "pPrismShape1" -p "pPrism1";
	rename -uid "539C5594-7445-8BE9-14BF-90A23F16D160";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode polyCube -n "polyCube2";
	rename -uid "231AF9F2-1F48-56FE-F153-B5AF11E31DFF";
	setAttr ".w" 4.3019905063615376;
	setAttr ".h" 0.47561461962969387;
	setAttr ".d" 5.1584576754922082;
	setAttr ".cuv" 4;
...
createNode polyCube -n "pasted__polyCube2";
	rename -uid "1D039ADC-1743-D56C-8D5D-16ACFA57E7F8";
	setAttr ".w" 4.3019905063615376;
	setAttr ".h" 0.47561461962969387;
	setAttr ".d" 5.1584576754922082;
	setAttr ".cuv" 4;
...
createNode polyCube -n "pasted__pasted__polyCube2";
	rename -uid "8ACCAEA6-4640-58ED-906F-7E8EBDE36E27";
	setAttr ".w" 4.3019905063615376;
	setAttr ".h" 0.47561461962969387;
	setAttr ".d" 5.1584576754922082;
	setAttr ".cuv" 4;
...
createNode polyCube -n "pasted__pasted__pasted__polyCube2";
	rename -uid "ECD72BD0-004A-3D47-036A-2393A557FD1D";
	setAttr ".w" 4.3019905063615376;
	setAttr ".h" 0.47561461962969387;
	setAttr ".d" 5.1584576754922082;
	setAttr ".cuv" 4;
...
createNode polyCube -n "pasted__polyCube3";
	rename -uid "A8FDEC8E-3943-4934-ED37-5D9FFE14A2F4";
	setAttr ".w" 4.3019905063615376;
	setAttr ".h" 0.47561461962969387;
	setAttr ".d" 5.1584576754922082;
	setAttr ".cuv" 4;
...
createNode polyCube -n "pasted__polyCube4";
	rename -uid "32BAB47F-3349-194B-02BD-C3B96B76E718";
	setAttr ".w" 4.3019905063615376;
	setAttr ".h" 0.47561461962969387;
	setAttr ".d" 5.1584576754922082;
	setAttr ".cuv" 4;
...
createNode polyPrism -n "polyPrism1";
	rename -uid "D1A83F97-6243-FF0B-DFB0-ADBCEBE24AAE";
...
connectAttr "|group1|pasted__pCube2|pasted__pCubeShape2.iog" "pasted__lambert6SG.dsm"
		 -na;
...
connectAttr "pasted__pasted__pCubeShape2.iog" "pasted__pasted__lambert6SG.dsm" -na
		;
...
connectAttr "pasted__pasted__pasted__lambert7.oc" "pasted__pasted__pasted__lambert6SG1.ss"
		;
connectAttr "pasted__pasted__pasted__pCubeShape2.iog" "pasted__pasted__pasted__lambert6SG1.dsm"
		 -na;
...
connectAttr "|group5|pasted__pCube2|pasted__pCubeShape2.iog" "pasted__lambert6SG1.dsm"
		 -na;
...
connectAttr "pPrismShape1.iog" "lambert9SG.dsm" -na;
connectAttr "lambert9SG.msg" "materialInfo8.sg";
connectAttr "lambert9.msg" "materialInfo8.m";
connectAttr "lambert10.oc" "lambert10SG.ss";
connectAttr "|group6|pasted__pCube2|pasted__pCubeShape2.iog" "lambert10SG.dsm" -na
		;
